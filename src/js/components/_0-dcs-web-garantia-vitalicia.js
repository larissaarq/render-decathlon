APP.component.GarantiaVitalicia = ClassAvanti.extend({
  init(options) {
    this.setup(options)
    this.start()
    this.bind()
  ...
  _submitForm() {
    ...
    var clCPF = $("#clCPF").unmask().val();
    var clEmail = $("#clEmail").val();
    var clPhone = $("#clPhone").val();
    var clUF = $("#clUF").val();
    var clOrderDate = $("#clOrderDate").val();
    var clNF = $("#clNF").val();
    var clBikeModel = $("#clBikeModel").val();
    var clBikeFrame = $("#clBikeFrame").val();
