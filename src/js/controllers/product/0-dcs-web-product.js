      ...
      `<div id="recomendation-products" class="shelf-recomendation">
        <div class="shelf-recomendation__content">
          <div class="av-container">
            <h3 class="shelf-recomendation__title">Veja também..</h3>
            <a class="av-modal-close button--close"></a>
            <div class="shelf-recomendation__products product-shelf">${$cloneShelfElm.html()}</div>
            <div class="shelf-recomendation__buttons">
                <a class="button button--small button--blue button--close gaClick" data-event-category="Pop-up PDP" data-event-action="Click - CTA" data-event-label="Continuar Comprando">Continuar comprando</a>
