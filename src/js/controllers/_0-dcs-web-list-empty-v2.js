APP.controller.ListEmptyV2 = ClassAvanti.extend({
  ...
  searchEmptyFunction() {
    ...
    for (var I = 0; I < urlCollection[bar].length; I++) {
      _self.generateShelfItems(urlCollection[bar][I], I);
    };

    var count = 0;
    var qtyShelf = urlCollection[bar].length;
    var intervalShelfSlick = setInterval(function () {
