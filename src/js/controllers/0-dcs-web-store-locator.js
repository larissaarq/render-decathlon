        ...
        return variables.map(item =>
          `
            <div class="store-item" data-state="${item.state}">
              ...
              <div class="store-item__button-natal">
                <a href="${item.pageLink}" class="button-natal" title="Confira os nossos horários especiais para Dezembro.">Confira os nossos horários especiais para Dezembro.</a>
